...
上面提到的工作和分类方式均出自于[视频理解基础模型及下游应用-王利民教授](https://aicarrier.feishu.cn/file/AVZQbWGi7ooyiuxHbLUcPOKknad)，含有一定的主观因素。更全面的工作可以直接查看[MMAction2 - Model Zoo](https://github.com/open-mmlab/mmaction2#-model-zoo-)。
